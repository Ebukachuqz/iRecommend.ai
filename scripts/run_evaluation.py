...
def run(args: argparse.Namespace) -> None:
    ...
    manifest = {
        ...
        "skip_bertscore": args.skip_bertscore,
        "force_rerun": args.force_rerun,
        "task_a_model_name": _most_frequent(rows_a, "model_name"),
        "task_b_model_name": _most_frequent(rows_b, "model_name"),
        "task_a_prompt_version": _most_frequent(rows_a, "prompt_version"),
        "task_b_prompt_version": _most_frequent(rows_b, "prompt_version"),
